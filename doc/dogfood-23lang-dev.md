...
**Label:** pharos-dev (Run 5, skip perl/ruby/terraform/java)
**Binary:** `bin/pharos-dev`
**Result:** **354/523 cells PASS** (67%)
...
|------|--------|------|
| `echo` | OK | ok (14b) |
| `runtime_processes` | OK | ok (10454b) |
| `runtime_supervision_tree` | OK | ok (1862b) |
| `runtime_ets_tables` | OK | ok (3184b) |
| `runtime_memory` | OK | ok (163b) |
| `runtime_applications` | OK | ok (136b) |
| `runtime_scheduler_util` | OK | ok (863b) |
| `runtime_log_tail` | OK | ok (25133b) |
| `runtime_log_level` | OK | ok (34b) |
| `runtime_log_clear` | OK | ok (16b) |
| `runtime_trace_lsp` | OK | ok (4693b) |
...
| `runtime_set_tool_timeout` | FAIL | isError=true: expected `timeout_ms: int` |
| `runtime_effective_tool_config` | OK | ok (144b) |
| `runtime_pid_info` | OK | ok (645b) |
