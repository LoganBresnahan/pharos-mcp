# Pharos Individual Contributor License Agreement ("Agreement")

Thank you for your interest in pharos-mcp ("the Project"), maintained by
Logan Bresnahan ("Maintainer"). To clarify the intellectual property
licence granted with Contributions from any person, the Maintainer must
have an Individual Contributor Licence Agreement on file that has been
...
protection of the Maintainer and downstream users; it does not change
your rights to use your own Contributions for any other purpose.

You accept and agree to the following terms and conditions for Your
present and future Contributions submitted to the Project. Except for
the licence granted herein to the Maintainer and recipients of software
distributed by the Maintainer, You reserve all right, title, and
...
behalf of, the Maintainer for the purpose of discussing and improving the
...
Contributions and such derivative works **under any licence terms,
including without limitation the AGPL-3.0-only and proprietary
commercial licences**, in source or object form.

You acknowledge that the Maintainer may distribute Your Contribution
under licences other than the project's then-current inbound licence,
including proprietary commercial licences offered to third parties.
...
Project, where such licence applies only to those patent claims
...
or that Your employer has executed a separate Corporate Contributor
Licence Agreement with the Maintainer.
...
## 6. Notice of Inaccurate Representations
...
To indicate Your acceptance of the above terms, comment on the pull
request containing Your Contribution with the exact text:

> I have read the CLA Document and I hereby sign the CLA

The CLA Assistant Lite bot will record Your signature in this repository
at [signatures/version1/cla.json](signatures/version1/cla.json). One
signature covers all future Contributions from the same GitHub account.

For commercial licensing inquiries see [COMMERCIAL.md](COMMERCIAL.md).
